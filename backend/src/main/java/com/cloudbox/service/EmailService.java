...
public class EmailService {
    ...
    private String fileBox(String fileName, String fileSize, String permission) {
        String permColor = "EDIT".equals(permission) ? "#b45309"
                : "DOWNLOAD".equals(permission) ? "#16a34a" : "#4285f4";
    ...
    public void sendWelcome(String to, String name) {
        String body = h("Welcome to CloudBox, " + name + "! 🎉") +
    ...
    public void sendFileUploaded(String to, String name, String fileName, String fileSize, String folder) {
        String body = h("File uploaded successfully") +
    ...
    private String infoCell(String label, String value) {
        return "<td style='padding:10px 12px;background:#f5f8ff;border-radius:8px;margin:4px;width:48%;'>" +
                "<div style='font-size:11px;color:#9baabf;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;'>"
                + label + "</div>" +
    ...
    public void sendFileShared(String to, String ownerEmail, String fileName, String permission) {
        ...
        String body = h("A file has been shared with you") +
                ...
                p("<small style='color:#9baabf;'>You need a CloudBox account to access this file. " +
                        "<a href='" + frontendUrl
                        + "/register' style='color:#4285f4;'>Create one free</a> if you don't have one.</small>");
    ...
    // ══════════════════════════════════════
    public void sendShareConfirmation(String to, String ownerName, String fileName, String sharedWith,
            String permission) {
        String body = h("Share confirmed") +
    ...
    public void sendPaymentSuccess(String to, String name, String plan, long amountPaise) {
        ...
        String body = h("Payment confirmed — " + plan + " Plan") +
                ...
                +
                "<div style='color:#fff;font-size:36px;font-weight:900;letter-spacing:-1px;'>₹"
                + String.format("%.2f", amount) + "</div>" +
                "<div style='color:rgba(255,255,255,0.75);font-size:13px;margin-top:6px;'>" + plan + " Plan · "
                + storageLabel + " Storage</div>" +
                "</div>" +
                divider() +
                btn(frontendUrl + "/dashboard", "Go to Dashboard →", "#4285f4") +
    ...
    public void sendPublicLink(String to, String senderEmail, String fileName, String linkUrl, String permission) {
        String permLabel = "EDIT".equals(permission) ? "View &amp; Edit"
                : "DOWNLOAD".equals(permission) ? "View &amp; Download" : "View only";
        String body = h("Someone shared a file link with you") +
    ...
    public void sendPasswordReset(String to, String name) {
        String body = h("Your password was reset") +
